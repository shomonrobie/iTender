...
from modules.price_to_win_html_report_generator import HTMLReportGenerator
...
def render_price_to_win_simulator_ui(db=None, subscription_manager=None):
    """Main UI function."""
    ...
    if st.session_state.get('analysis_generated'):
        ...
        # Export section
        from modules.price_to_win_html_report_generator import render_report_section
